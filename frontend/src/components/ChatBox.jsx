...
const ChatBox = ({ documentId, isProcessing }) => {
      ...
      <form onSubmit={handleSubmit} className="mt-auto">
        <div className="flex items-center">
          <input
            ...
            placeholder={
              !documentId
                ? "Upload a PDF or enter a URL to start chatting"
          ...
          <button
            type="submit"
            disabled={!input.trim() || !documentId || isProcessing || isLoading}
            className={`px-4 py-2 rounded-r-lg text-white ${
              !input.trim() || !documentId || isProcessing || isLoading
